...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/flareworkers-1c0f
```

A live public deployment of this template is available at [https://flareworkers-1c0f.templates.workers.dev](https://flareworkers-1c0f.templates.workers.dev)
